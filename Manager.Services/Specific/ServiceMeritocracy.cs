    ...
    public ViewCrudMeritocracy Get(string id)
    {
      try
      {
        ...
        return new ViewCrudMeritocracy()
        {
          ...
          QtdMonitoring = meritocracy.QtdMonitoring,
          QtdPraise = meritocracy.QtdPraise,
          QtdRecommendation = meritocracy.QtdRecommendation,
          QtdCertification = meritocracy.QtdCertification,
          QtdPlan = meritocracy.QtdPlan,
