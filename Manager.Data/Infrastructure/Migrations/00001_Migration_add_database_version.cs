  ...
  public class Migration_add_database_version : IMigration
  {
    public void Up(string _idNextMigration, IMongoDatabase context)
    {
      try
      {
        ...
        script = script + @"db.Area.find({}).forEach(function(item){";
        ...
        script = script + @"db.Axis.find({}).forEach(function(item){";
        script = script + @"	var model = {";
        script = script + @"		_id: item._id,";
        script = script + @"		Name: item.Name,";
        script = script + @"		Company: {";
        ...
        script = script + @"db.Log.find({}).forEach(function(item){";
        ...
        script = script + @"db.Company.find({}).forEach(function(item){";
        script = script + @"	var model = {";
        script = script + @"		_id: item._id,";
        script = script + @"		Name: item.Name,";
        script = script + @"		_idAccount: item._idAccount,";
        ...
        script = script + @"db.Establishment.find({}).forEach(function(item){";
        ...
        script = script + @"db.LogMessages.find({}).forEach(function(item){";
        ...
        script = script + @"db.ProcessLevelOne.find({}).forEach(function(item){";
        ...
        script = script + @"db.ProcessLevelTwo.find({}).forEach(function(item){";
        ...
        script = script + @"db.Sphere.find({}).forEach(function(item){";
        script = script + @"	var model = {";
        script = script + @"		_id: item._id,";
        script = script + @"		Name: item.Name,";
        script = script + @"		Company: {";
        ...
        script = script + @"db.TextDefault.find({}).forEach(function(item){";
        script = script + @"	var model = {";
        script = script + @"		_id: item._id,";
        script = script + @"		Name: item.Name,";
        script = script + @"		Company: {";
        ...
        script = script + @"db.Skill.find({}).forEach(function(item){";
        script = script + @"	var model = {";
        script = script + @"		_id: item._id,";
        script = script + @"		Name: item.Name,";
        script = script + @"		_idAccount: item._idAccount,";
        ...
        script = script + @"db.Schooling.find({}).forEach(function(item){";
        script = script + @"	var model = {";
        script = script + @"		_id: item._id,";
        script = script + @"		Name: item.Name,";
        script = script + @"		Order: item.Order,";
        ...
        script = script + @"db.User.find({}).forEach(function(item){";
        script = script + @"	var model = {";
        script = script + @"		_id: item._id,";
        script = script + @"		_idAccount: item._idAccount,";
        script = script + @"		Status: item.Status,";
        ...
        script = script + @"db.Questions.find({}).forEach(function(item){";
        script = script + @"	var model = {";
        script = script + @"		_id: item._id,";
        script = script + @"		Name: item.Name,";
        script = script + @"		Company: {";
        ...
        script = script + @"db.Group.find({}).forEach(function(item){";
        script = script + @"	var model = {";
        script = script + @"		_id: item._id,";
        script = script + @"		_idAccount: item._idAccount,";
        script = script + @"		Status: item.Status,";
        ...
        script = script + @"db.Person.find({}).forEach(function(item){";
        script = script + @"	var model = {";
        script = script + @"		_id: item._id,";
        script = script + @"		_idAccount: item._idAccount,";
        script = script + @"		Status: item.Status,";
        ...
        script = script + @"db.Occupation.find({}).forEach(function(item){";
        script = script + @"	var model = {";
        script = script + @"		_id: item._id,";
        script = script + @"		_idAccount: item._idAccount,";
        script = script + @"		Status: item.Status,";
        ...
        script = script + @"db.SalaryScale.find({}).forEach(function(item){";
        script = script + @"	var model = {";
        script = script + @"		_id: item._id,";
        script = script + @"		_idAccount: item._idAccount,";
        script = script + @"		Status: item.Status,";
        ...
        script = script + @"db.Plan.find({}).forEach(function(item){";
        script = script + @"	var model = {";
        script = script + @"		_id: item._id,";
        script = script + @"		_idAccount: item._idAccount,";
        script = script + @"		Status: item.Status,";
        ...
        script = script + @"db.Plan.find({}).forEach((item)=>{";
        script = script + @"	db.Monitoring.find({_id:item._idMonitoring}).forEach((moni)=>{";
        script = script + @"		if(moni.Person != null){";
        ...
        script = script + @"			 db.Plan.update({_id:item._id}, { Person: person}, { multi: true});";
        script = script + @"		}";
        script = script + @"	});";
        script = script + @"});";

        script = script + @"db.Monitoring.find({ }).forEach((moni)=> {";
        script = script + @"	var person = {";
        script = script + @"		_id: moni.Person._id,";
        script = script + @"		Name: moni.Person.Name,";
        script = script + @"		_idManager: moni.Person._idManager,";
        ...
        script = script + @"db.Checkpoint.find({}).forEach(function(item){";
        script = script + @"	var model = {";
        script = script + @"		_id: item._id,";
        script = script + @"		_idAccount: item._idAccount,";
        script = script + @"		Status: item.Status,";
        ...
        script = script + @"db.OnBoarding.find({}).forEach(function(item){";
        script = script + @"	var model = {";
        script = script + @"		_id: item._id,";
        script = script + @"		_idAccount: item._idAccount,";
        script = script + @"		Status: item.Status,";
        ...
        script = script + @"db.Monitoring.find({}).forEach(function(item){";
        script = script + @"	var model = {";
        script = script + @"		_id: item._id,";
        script = script + @"		_idAccount: item._idAccount,";
        script = script + @"		Status: item.Status,";
        ...
        var docVersion = new BsonDocument()
        {
            { "eval", script }
        };
        var commandVersion = new BsonDocumentCommand<BsonDocument>(doc);
        var responseVersion = context.RunCommand(commandVersion);
