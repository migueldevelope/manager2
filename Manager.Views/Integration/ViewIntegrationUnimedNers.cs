...
#pragma warning disable IDE1006 // Estilos de Nomenclatura
  public class ViewIntegrationUnimedNers
  {
    ...
    public string des_mot_afastamento { get; set; }
    public string cdn_estab { get; set; }
    public string sit_funcionario { get; set; }
    public string cdn_estab_chefe { get; set; }
    public string cdn_cart_prof { get; set; }
    public string des_cargo { get; set; }
    public string cdn_identidade { get; set; }
    public string nom_pessoa { get; set; }
    public string num_celular { get; set; }
    public string tip_sexo { get; set; }
    public string cdn_cpf { get; set; }
    public string nom_empresa_chefe { get; set; }
