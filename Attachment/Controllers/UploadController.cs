...
namespace EdeskIntegration.Controllers
{
  ...
  public class UploadController : Controller
  {
    ...
    public UploadController(IHttpContextAccessor contextAccessor, IServiceCompany _serviceCompany, IServicePerson _servicePerson, IServicePlan _servicePlan,
      ...
      IServiceHRDrive _serviceHRDrive, IServiceObjective _serviceObjective)
    {
      ...
      serviceObjective.SetUser(contextAccessor);
    ...
    public async Task<ObjectResult> PostSpeechRecognitionOnboarding([FromBody]ViewTime time, string idregister, string iditem, EnumUserComment typeuser)
    {
      try
      {
        //foreach (var file in HttpContext.Request.Form.Files)
    ...
    public async Task<ObjectResult> PostEventHistoricTemp(string ideventhistorictemp)
    {
      ...
      foreach (var file in HttpContext.Request.Form.Files)
      {
        ...
        serviceEvent.SetAttachmentHistoricTemp(ideventhistorictemp, url, file.FileName, attachment._id);
        listAttachments.Add(attachment);
      }
      return Ok(listAttachments);
    }
