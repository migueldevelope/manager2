...
namespace Manager.Controllers
{
  ...
  public class CheckpointController : DefaultController
  {
    ...
    {
      return await Task.Run(() =>service.ListWaitPerson(idperson));
    }
    /// <summary>
    ...
    {
      return await Task.Run(() =>service.NewCheckpoint(idperson));
    }
    /// <summary>
    ...
    {
      return await Task.Run(() =>service.GetCheckpoint(id));
    }
    /// <summary>
    ...
    {
      return await Task.Run(() =>Ok( service.UpdateCheckpoint(view)));
    }
    /// <summary>
    ...
    {
      return await Task.Run(() =>service.PersonCheckpointEnd(id));
    }
    /// <summary>
    ...
    {
      return await Task.Run(() =>service.DeleteCheckpoint(id));
    }
    /// <summary>
