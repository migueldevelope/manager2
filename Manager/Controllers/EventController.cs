...
namespace Manager.Controllers
{
  ...
  public class EventController : Controller
  {
    ...
    //public List<ViewListPerson> ListPersonInstructor(string idevent, string idcompany, int count = 10, int page = 1, string filter = "")
    //{
    //  long total = 0;
    ...
    //public List<ViewListPerson> ListPersonParticipants(string idevent, string idcompany, int count = 10, int page = 1, string filter = "")
    //{
    //  long total = 0;
