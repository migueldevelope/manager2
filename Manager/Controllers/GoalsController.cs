...
namespace Manager.Controllers
{
  ...
  public class GoalsController : DefaultController
  {
    ...
    {
      return await service.NewGoalsPeriod(view);
    }
    /// <summary>
    ...
    {
      return await service.GetGoalsPeriod(id);
    }
    /// <summary>
    ...
    {
      return await service.UpdateGoalsPeriod(view);
    }
    /// <summary>
    ...
    {
      return await service.DeleteGoalsPeriod(id);
    }
    #endregion
    ...
    {
      return await service.NewGoalsCompany(view);
    }
    /// <summary>
    ...
    {
      return await service.GetGoalsCompany(id);
    }
    /// <summary>
    ...
    {
      return await service.UpdateGoalsCompany(view);
    }
    /// <summary>
    /// Alterar um objetivo da empresa em um período
    /// </summary>
    ...
    {
      return await service.UpdateGoalsCompanyAchievement(view);
    }
    ...
    {
      return await service.DeleteGoalsCompany(id);
    }
    #endregion
    ...
    {
      return await service.NewGoalsManagerPortal(view);
    }
    ...
    {
      return await service.NewGoalsManager(view);
    }
    /// <summary>
    /// Listar os objetivos da empresa e do período
    /// </summary>
    ...
    {
      return await service.GetGoalsManager(id);
    }
    ...
    {
      return await service.GetGoalsManagerPortal(id);
    }
    ...
    {
      return await service.UpdateGoalsManager(view);
    }
    ...
    {
      return await service.UpdateGoalsManagerPortal(view);
    }
    ...
    {
      return await service.UpdateGoalsManagerAchievement(view);
    }
    ...
    {
      return await service.DeleteGoalsManager(id);
    }
    #endregion
    ...
    {
      return await service.NewGoalsPersonPortal(view);
    }
    ...
    //{
    //  return await service.NewGoalsPerson(view);
    //}
    /// <summary>
    /// Listar os objetivos da empresa e do período
    /// </summary>
    ...
    {
      return await service.GetGoalsPerson(id);
    }
    ///// <summary>
    ///// Alterar um objetivo da empresa em um período
    ///// </summary>
    ...
    //{
    //  return await service.UpdateGoalsPerson(view);
    //}
    ...
    {
      return await service.UpdateGoalsPersonPortal(view);
    }
    ...
    {
      return await service.UpdateGoalsPersonAchievement(view);
    }
    ...
    {
      return await service.DeleteGoalsPerson(id);
    }
    #endregion
    ...
    {
      return await service.NewGoalsPersonControl(idperson, idperiod);
    }
    ...
    {
      return await service.GetGoalsPersonControl(id);
    }
    /// <summary>
    /// Alterar um objetivo da empresa em um período
    /// </summary>
    ...
    {
      return await service.UpdateGoalsPersonControl(view);
    }
    ...
    {
      return await service.DeleteGoalsPersonControl(idperson, idperiod);
    }
    #endregion
  }
}