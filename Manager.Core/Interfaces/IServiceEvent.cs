...
namespace Manager.Core.Interfaces
{
  public interface IServiceEvent
  {
    ...
    Task<List<ViewListEvent>> List( ref long total, int count = 10, int page = 1, string filter = "");
    Task<List<ViewListEventHistoric>> ListEventHistoricPerson(string id,  ref long total, int count = 10, int page = 1, string filter = "");
    ...
    Task<List<ViewListCourse>> ListCourse( ref long total, int count = 10, int page = 1, string filter = "");
    ...
    Task<List<ViewCrudCourseESocial>> ListCourseESocial( ref long total, int count = 10, int page = 1, string filter = "");
    ...
    Task<List<ViewListEventHistoric>> ListEventHistoric( ref long total, int count = 10, int page = 1, string filter = "");
    ...
    Task<List<ViewCrudEntity>> ListEntity( ref long total, int count = 10, int page = 1, string filter = "");
    Task<List<ViewListPersonResume>> ListPersonInstructor(string idevent, string idcompany,  ref long total, int count = 10, int page = 1, string filter = "");
    Task<List<ViewListPersonResume>> ListPersonParticipants(string idevent, string idcompany,  ref long total, int count = 10, int page = 1, string filter = "");
    Task<List<ViewCrudParticipant>> ListParticipants(string idevent,  ref long total, int count = 10, int page = 1, string filter = "");
    Task<List<ViewListEvent>> ListEventOpen( ref long total, int count = 10, int page = 1, string filter = "");
    Task<List<ViewListEvent>> ListEventEnd( ref long total, int count = 10, int page = 1, string filter = "");
    Task<List<ViewListEvent>> ListEventOpenSubscription(string idperson,  ref long total, int count = 10, int page = 1, string filter = "");
    Task<List<ViewListEvent>> ListEventSubscription(string idperson,  ref long total, int count = 10, int page = 1, string filter = "");
  }
}
