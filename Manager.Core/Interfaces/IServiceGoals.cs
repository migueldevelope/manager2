...
namespace Manager.Core.Interfaces
{
  public interface IServiceGoals
  {
    ...
    Task<List<ViewListGoal>> List( ref long total, int count = 10, int page = 1, string filter = "");
    Task<List<ViewListGoal>> ListCompany(string id,  ref long total, int count = 10, int page = 1, string filter = "");
    Task<List<ViewListGoal>> ListManager(string id,  ref long total, int count = 10, int page = 1, string filter = "");
    ...
    Task<List<ViewCrudGoalPeriod>> ListGoalsPeriod( ref long total, int count = 10, int page = 1, string filter = "");
    ...
    Task<List<ViewCrudGoalItem>> ListGoalsCompany(string idGoalsPeriod, string idCompany,  ref long total, int count = 10, int page = 1, string filter = "");
    Task<List<ViewListGoalCompany>> ListGoalsCompany( ref long total, int count = 10, int page = 1, string filter = "");
    ...
    Task<ViewListGoalsItem> ListGoalsPerson(string idGoalsPeriod, string idPerson,  ref long total, int count = 10, int page = 1, string filter = "");
    Task<List<ViewListGoalPerson>> ListGoalsPerson( ref long total, int count = 10, int page = 1, string filter = "");
    ...
    Task<ViewListGoalsItem> ListGoalsManager(string idGoalsPeriod, string idManager,  ref long total, int count = 10, int page = 1, string filter = "");
    Task<List<ViewListGoalManager>> ListGoalsManager( ref long total, int count = 10, int page = 1, string filter = "");
    ...
    Task<List<ViewListGoalPersonControl>> ListGoalsPersonControl(string idmanager, ref long total, int count, int page, string filter);
