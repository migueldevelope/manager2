...
namespace Manager.Core.Interfaces
{
  public interface IServiceMonitoring
  {
    ...
    string AddCommentsSpeech(string idmonitoring, string iditem, string link, EnumUserComment user, string totalimte);
    ...
    string UpdateStatusMonitoring(string idmonitoring, EnumStatusMonitoring status);
        #endregion
